            ...
            <td className="p-3 text-lg text-gray-800">
                <fetcher.Form method="POST">
                    <button
                        ...
                        name="id"
                        value={product.id}
                        className={`${isAvailable ? 'text-black': 'text-red-600'} rounded-lg p-2 text-xs font-bold uppercase w-full text-center border border-black-100 hover:cursor-pointer`}
                    >
